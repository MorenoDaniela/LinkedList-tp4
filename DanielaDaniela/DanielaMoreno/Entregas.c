...
int Entregas_getCantidadString(Entregas* this, char* cantidad)
{
    ...
    if(this != NULL && cantidad != NULL)
    {
        Entregas_getCantidad(this,&buffer);
...
int Informes_setTotal(Informes* this,int total)
{
    ...
    if (this!=NULL && total>=0 && isValidInt(total,1,99999999))
    {
        this->total=total;
        retorno=0;
    }
...
int Informes_setTipos(Informes* this,int porTipo)
{
    ...
    if (this!=NULL && porTipo>=0 && isValidInt(porTipo,1,99999999))
    {
        this->total=total;
        retorno=0;
    }
...
int Informes_setBultos(Informes* this,int bultos)
{
    ...
    if (this!=NULL && bultos>=0 && isValidInt(bultos,1,99999999))
    {
        this->bultos=bultos;
        retorno=0;
    }
...
int Informes_setPromedioBulto(Informes* this,int promedioBulto)
{
    ...
    if (this!=NULL && promedioBulto>=0 && isValidInt(promedioBulto,1,99999999))
    {
        this->promedioBulto=promedioBulto;
        retorno=0;
    }
    return retorno;
}
...
int Informes_setPromedioEntrega(Informes* this,int promedioEntrega)
{
    ...
    if (this!=NULL && promedioEntrega>=0 && isValidInt(promedioEntrega,1,99999999))
    {
        this->promedioEntrega=promedioEntrega;
        retorno=0;
    }
    return retorno;
}
